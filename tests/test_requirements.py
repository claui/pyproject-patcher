...
def fixture_requirements_array() -> tomlkit.items.Array:
    return tomlkit.array('["setuptools", "wheel", "setuptools-git-versioning<2"]')


class TestRequirementsSection:
    @pytest.fixture(name="section")
    def fixture_section(self, requirements_array: tomlkit.items.Array) -> RequirementsSection:
    ...
    def test_remove_dependency(self, section: RequirementsSection) -> None:
        # When
    ...
    def test_remove_dependency_nonexistent_prefix(self, section: RequirementsSection) -> None:
        # When
        section.remove_dependency("setuptools-git")

        # Then
        assert section.array == ["setuptools", "wheel", "setuptools-git-versioning<2"]

    def test_strip_constraint(self, section: RequirementsSection) -> None:
        # When
        section.strip_constraint("setuptools-git-versioning")

        # Then
        assert section.array == ["setuptools", "wheel", "setuptools-git-versioning"]

    def test_strip_constraint_nonexistent_prefix(self, section: RequirementsSection) -> None:
        # When
